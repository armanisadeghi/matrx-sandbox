> ARCHIVED 2026-09-08 — historical May 2026 integration evidence, superseded by /Users/armanisadeghi/code/common-docs/systems/infrastructure/sandboxes/STATE.md. Old hostname, private binding advice, environment-variable proposal, and missing conversation support below are historical, not current implementation instructions.

# Frontend sandbox integration — historical evidence
